...
public class Technology extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static Technology Instance;

    public static Technology getInstance() {
        if (Instance == null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.mtechRecycler);
        refreshLayout = v.findViewById(R.id.mtechSwipeRefresh);
    ...
    private void getTopHeadlinesNews() {
        ...
        Call<News> dataCall = service.getTechnologyNews();
